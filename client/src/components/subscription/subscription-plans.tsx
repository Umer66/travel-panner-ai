...
interface Plan {
  ...
  planId: "free" | "premium" | "premium_plus"; // Add this field
}
...
const plans: Plan[] = [
  ...
  },
  {
    ...
    tripLimit: 50, // Updated to match your backend limits
    planId: "premium", // Add this
    popular: true,
    features: [
      { text: "50 AI-generated trips", included: true }, // Updated
  ...
  },
  {
    ...
    tripLimit: 100, // Updated to match your backend limits
    planId: "premium_plus", // Add this
    features: [
      { text: "100 AI-generated trips", included: true }, // Updated
...
interface SubscriptionPlansProps {
  ...
  onUpgrade?: (planName: string) => void; // Make this optional
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {plans.map((plan) => {
          const isCurrentPlan = currentPlan.toLowerCase() === plan.planId;
          const canUpgrade = plan.planId !== "free" && !isCurrentPlan;
          const isDowngrade = (currentPlan === "premium_plus" && plan.planId === "premium") || 
                             (currentPlan !== "free" && plan.planId === "free");
          
          return (
            <Card key={plan.name} className={`relative ${plan.popular ? 'border-primary' : ''} ${isCurrentPlan ? 'ring-2 ring-green-500' : ''}`}>
              {plan.popular && (
              ...
              <CardFooter>
                {isCurrentPlan ? (
                  ...
                  <UpgradeButton
                    userId={userId}
                    plan={plan.planId as "premium" | "premium_plus"}
